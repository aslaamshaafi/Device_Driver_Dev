...
/* it is a polling mechanisim and check if lock is available. No sleep and wakeup. There is no ownership.*/
/*it also has dynamci and static implementation, here we are using dynamic one*/
